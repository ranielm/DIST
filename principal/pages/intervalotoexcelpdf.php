            ...
            <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-calendar fa-fw"></i> Escolha as datas da auditoria
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <input id="diaescolhido" max="2060-01-01" name="dia2" required="required" type="date" placeholder="2017-07-17"/>
                                    </p>

                                    <p> 
                                    <label for="diaescolhido" class="diaescolhido" >Qual a data final?</label>
                                    <input id="diaescolhido" max="2060-01-01" name="dia1" required="required" type="date" placeholder="2017-07-17"/>
                                    </p>
