...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header">Gerar relatório</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-calendar fa-fw"></i> Escolha a data a qual quer fazer auditoria
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <form  action="diatoexcel.php" method="post" autocomplete="on"> 
                                    
                                    <p> 
                                    <label for="diaescolhido" class="diaescolhido" >Em qual dia deseja ver o estado do banco?</label>
                                    <input id="diaescolhido" max="2060-01-01" name="diaescolhido" required="required" type="date" placeholder="2017-07-17"/>
                                    </p>

                                    <button type="submit" class="btn btn-primary">Escolher dia</button>
