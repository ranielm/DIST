...
$nome = $_POST['username'];
$quantidadetotal = $_POST['mail'];
$alertadeexpiracao = $_POST['role'];
$datadeexpiracao = $_POST['phone'];
$ehperecivel = $_POST['usertype'];
$fabricante = $_POST['password'];
$estoqueminimo = $_POST['password_confirm'];
$setor = $_POST['setor'];
$tipo = $_POST['tipo'];
